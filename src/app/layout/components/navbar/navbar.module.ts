...
import { NavbarMaintenanceNotificationComponent } from './navbar-maintenance-notification/navbar-maintenance-notification.component';
...
@NgModule({
  declarations: [
    ...
    NavbarMaintenanceNotificationComponent
  ],
