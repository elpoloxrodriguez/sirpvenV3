...
@Component({
  selector: 'app-navbar-maintenance-notification',
  templateUrl: './navbar-maintenance-notification.component.html',
})
export class NavbarMaintenanceNotificationComponent implements OnInit {
  ...
  async NotificacionesTotal(){
    this.xAPI.funcion = "IPOSTEL_R_PagoMantenimiento_Notificaciones";
